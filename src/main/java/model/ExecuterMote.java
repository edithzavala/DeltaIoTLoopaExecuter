...
public class ExecuterMote {

    protected double battery;
    protected int dataProbability;
    protected List<ExecuterLink> links;
    protected int load;
    protected Integer moteid;
    protected int parents;
    
	public ExecuterLink getLinkWithDest(int destination){
		for(ExecuterLink link: this.links)
     ...
     * 
     */
    public List<ExecuterLink> getLinks() {
        if (links == null) {
            links = new ArrayList<ExecuterLink>();
        }
        return this.links;
    }
